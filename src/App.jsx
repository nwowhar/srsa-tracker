...
const PIN_CODE = "1111";
// Shared code that opens the customer view for the machine it's tied to.
// Simpler than an account for owners who just want to glance at progress.
const CLIENT_CODES = { "306366": {serialMatch: "ZGF306366"} };
...
export default function App() {
  ...
  const enterPin = digit => {
    ...
    if (next.length === 6) {
      const code = CLIENT_CODES[next];
      const j = code && jobs.find(x => (x.serial||"").toUpperCase().includes(code.serialMatch.toUpperCase()));
